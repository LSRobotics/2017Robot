...
public class PDP {
    ...
    public static void updateCurrents(){
    	currents[0] = pdp.getCurrent(Statics.PDP_RIGHTPortFront);
    	currents[1] = pdp.getCurrent(Statics.PDP_RIGHTPortBack);
    	currents[2] = pdp.getCurrent(Statics.PDP_LEFTPortFront);
    	currents[3] = pdp.getCurrent(Statics.PDP_LEFTPortBack);
    }
}
