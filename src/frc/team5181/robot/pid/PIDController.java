...
public class PIDController implements Task {
	 ...
	 */
	public void withProportionalConstant(double proportionalConstant) {
	 ...
	 */
	public void withIntegralConstant(double integralConstant) {
	 ...
	 */
	public void withDerivativeConstant(double derivativeConstant) {
